...
const { add_catagory, upload_product, updateProduct, adminApproval, CustomerReview, singeleProduct } = require('../../Controllers/productController')
...
productRoute.post('/singleProduct/:slug', singeleProduct)
